...
def generate_task(language: str, difficulty: str) -> dict:
    ...
    templates = {
        "easy": {
            ...
            "description": "รับตัวเลข 2 จำนวน แล้วแสดงผลรวม",
            "accepted_outputs": ["15"],
            "hint": "ใช้การรับ input และบวกค่า",
            "testcases": [{"input": "7 8", "accepted_outputs": ["15"]}],
        },
        "medium": {
            "title": "Even Odd Checker",
            "description": "รับจำนวนเต็ม 1 ค่า แล้วแสดง EVEN หรือ ODD",
            "accepted_outputs": ["EVEN"],
            "hint": "ใช้ if-else และเครื่องหมาย %",
            "testcases": [{"input": "10", "accepted_outputs": ["EVEN"]}],
        },
        "hard": {
            "title": "Prime Detector",
            "description": "รับจำนวนเต็ม 1 ค่า แล้วแสดง PRIME หรือ NOT PRIME",
            "accepted_outputs": ["PRIME"],
            "hint": "ลองวนลูปหารตั้งแต่ 2 ถึง sqrt(n)",
            "testcases": [{"input": "13", "accepted_outputs": ["PRIME"]}],
        },
    }
    ...
    return {
        ...
        "required_keywords_any": required,
