...
class AdminPanelView(discord.ui.View):
    ...
    @discord.ui.button(label="📂 เปลี่ยนบทเรียน", style=discord.ButtonStyle.secondary, row=0)
    ...
    @discord.ui.button(label="📄 ทำสำเนาโจทย์", style=discord.ButtonStyle.primary, row=1)
    async def duplicate(self, interaction: discord.Interaction, _: discord.ui.Button) -> None:
        await self.on_duplicate(interaction)

    @discord.ui.button(label="📦 นำเข้า/ส่งออกแบบชุด", style=discord.ButtonStyle.primary, row=1)
...
class EditFieldView(discord.ui.View):
    ...
    @discord.ui.button(label="📘 คำตอบหลัก", style=discord.ButtonStyle.secondary)
    async def main_answer(self, interaction: discord.Interaction, _: discord.ui.Button) -> None:
        await self.on_select(interaction, "main_answer")

    @discord.ui.button(label="🧩 คำตอบเสริม", style=discord.ButtonStyle.secondary)
    async def alt_answers(self, interaction: discord.Interaction, _: discord.ui.Button) -> None:
        await self.on_select(interaction, "alt_answers")
...
class BulkActionView(discord.ui.View):
    ...
    @discord.ui.button(label="📤 ส่งออกบทเรียน", style=discord.ButtonStyle.primary)
    async def export(self, interaction: discord.Interaction, _: discord.ui.Button) -> None:
        await self.on_export(interaction)

    @discord.ui.button(label="📥 นำเข้าบทเรียน", style=discord.ButtonStyle.success)
