...
class ProfileCog(commands.Cog):
    ...
    @app_commands.command(name="โปรไฟล์", description="ดูโปรไฟล์ของคุณ")
    async def profile_th(self, interaction: discord.Interaction, สมาชิก: discord.Member | None = None) -> None:
        await self.profile(interaction, สมาชิก)
