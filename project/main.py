...
class CodingArenaBot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        for extension in ["cogs.learn", "cogs.profile", "cogs.rank", "cogs.admin", "cogs.daily", "cogs.achievement", "cogs.chat_exp"]:
    ...
    async def on_ready(self) -> None:
        ...
        await self.change_presence(activity=discord.Game(name="🖥️ สอนเขียนโค้ด | /learn"))
